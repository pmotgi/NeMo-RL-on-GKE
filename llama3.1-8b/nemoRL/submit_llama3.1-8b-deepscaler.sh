...
uv run python examples/run_grpo_math.py \
  ...
  logger.wandb.name='llama3.1-8b-deepscaler-grpo-2nodes' grpo.max_num_steps=100 checkpointing.checkpoint_dir=/data/nemo_rl_llama3_8b_ds_cp data.dataset_name='DeepScaler'
